    ...
    <div style={{ fontFamily:'Georgia, serif', display:'flex', gap:'0', minHeight:'600px', position:'relative' }}>
      ...
      <div style={{ width:'200px', flexShrink:0, borderRight:'1px solid rgba(255,255,255,0.07)', paddingRight:'0' }}>
        ...
        <div style={{ padding:'12px', borderTop:'1px solid rgba(255,255,255,0.07)' }}>
          ...
          <button onClick={() => { setDialerLead(null); setShowDialer(true); setShowDialerPanel(true); }} style={{ display:'block', width:'100%', background:'rgba(74,222,128,0.1)', color:'#4ade80', border:'1px solid rgba(74,222,128,0.25)', borderRadius:'2px', padding:'8px 10px', cursor:'pointer', fontSize:'11px', marginBottom:'6px', textAlign:'left' }}>📞 Direct Dialer</button>
