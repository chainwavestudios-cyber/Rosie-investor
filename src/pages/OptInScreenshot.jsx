export default function OptInScreenshot() {
  return (
    <div style={{ minHeight: '100vh', background: '#f3f4f6', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'sans-serif' }}>
      <div style={{ marginBottom: '16px', color: '#6b7280', fontSize: '13px' }}>
        Rosie AI — SMS Opt-In Form Screenshot · <a href="/optin" style={{ color: '#b8933a' }}>investors.rosieai.tech/optin</a>
      </div>
      <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 4px 24px rgba(0,0,0,0.12)', overflow: 'hidden', maxWidth: '520px', width: '100%' }}>
        {/* Replicated static opt-in form for screenshot purposes */}
